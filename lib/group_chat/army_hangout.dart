...
class ArmyHangout extends StatefulWidget {
  const ArmyHangout({Key? key}) : super(key: key);

  @override
  State<ArmyHangout> createState() => _ArmyHangoutState();
}

class _ArmyHangoutState extends State<ArmyHangout> {
  ...
  void messagesStream() async {
    await for (var snapshot in _firestore.collection('army_chat').snapshots()) {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'images/army.png'), // Replace with your own image
                fit: BoxFit.cover,
              ),
            ),
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            _firestore.collection('army_chat').add({
                              'text': messageText,
                              'sender': username,
                              "time": DateTime.now(),
                            });
