...
class BangtanBuddies extends StatefulWidget {
  const BangtanBuddies({Key? key}) : super(key: key);

  @override
  State<BangtanBuddies> createState() => _BangtanBuddiesState();
}

class _BangtanBuddiesState extends State<BangtanBuddies> {
  ...
  void messagesStream() async {
    await for (var snapshot
        in _firestore.collection('buddies_chat').snapshots()) {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'images/buddies.png'), // Replace with your own image
                fit: BoxFit.cover,
              ),
            ),
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            _firestore.collection('buddies_chat').add({
                              'text': messageText,
                              'sender': username,
                              "time": DateTime.now(),
                            });
