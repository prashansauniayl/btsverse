...
class MicDrop extends StatefulWidget {
  const MicDrop({Key? key}) : super(key: key);

  @override
  State<MicDrop> createState() => _MicDropState();
}

class _MicDropState extends State<MicDrop> {
  ...
  void messagesStream() async {
    await for (var snapshot
        in _firestore.collection('micdrop_chat').snapshots()) {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'images/micdrop.png'), // Replace with your own image
                fit: BoxFit.cover,
              ),
            ),
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            _firestore.collection('micdrop_chat').add({
                              'text': messageText,
                              'sender': username,
                              "time": DateTime.now(),
                            });
      ...
      child: Column(
        ...
        children: [
          ...
          Material(
            ...
            elevation: 4.0,
            color: isMe ? Colors.deepPurpleAccent.shade100 : Colors.white,
            child: Padding(
              padding:
              ...
              child: Text(
                text,
                style: TextStyle(
                  color: isMe ? Colors.white : Colors.deepPurpleAccent.shade100,
                  fontSize: 15,
                  fontFamily: 'Sen',
                ),
              ),
