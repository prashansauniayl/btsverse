...
class PurpleChat extends StatefulWidget {
  const PurpleChat({Key? key}) : super(key: key);

  @override
  State<PurpleChat> createState() => _PurpleChatState();
}

class _PurpleChatState extends State<PurpleChat> {
  ...
  void messagesStream() async {
    await for (var snapshot
        in _firestore.collection('purple_chat').snapshots()) {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'images/purple.png'), // Replace with your own image
                fit: BoxFit.cover,
              ),
            ),
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            _firestore.collection('purple_chat').add({
                              'text': messageText,
                              'sender': username,
                              "time": DateTime.now(),
                            });
