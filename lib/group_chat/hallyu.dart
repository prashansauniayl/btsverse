...
class Hallyu extends StatefulWidget {
  const Hallyu({Key? key}) : super(key: key);

  @override
  State<Hallyu> createState() => _HallyuState();
}

class _HallyuState extends State<Hallyu> {
  ...
  void messagesStream() async {
    await for (var snapshot
        in _firestore.collection('hallyu_chat').snapshots()) {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'images/hallyu.png'), // Replace with your own image
                fit: BoxFit.cover,
              ),
            ),
                ...
                children: <Widget>[
                  ...
                  Container(
                    decoration: BoxDecoration(
                      border: Border(
                        top: BorderSide(
                            color: Colors.purpleAccent.shade100, width: 2.0),
                      ),
                    ),
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            _firestore.collection('hallyu_chat').add({
                              'text': messageText,
                              'sender': username,
                              "time": DateTime.now(),
                            });
      ...
      child: Column(
        ...
        children: [
          ...
          Material(
            ...
            elevation: 4.0,
            color: isMe ? Colors.purpleAccent.shade100 : Colors.white,
            child: Padding(
              padding:
              ...
              child: Text(
                text,
                style: TextStyle(
                  color: isMe ? Colors.white : Colors.purpleAccent.shade100,
                  fontSize: 15,
                  fontFamily: 'Sen',
                ),
              ),
